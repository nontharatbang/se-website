  ...
  return (
    <div className="mt-28">
      <div className="bg-[url('../public/internshipp.svg')] bg-cover bg-center min-h-[480px] text-white font-bold">
        <div>
          <h1 className="px-20 pt-[200px] text-7xl uppercase">Internships</h1>
        </div>
      </div>
      <div className="my-10 mx-auto px-10 h-full w-full max-w-[1920px]">
        <div className="px-10 my-10 w-full flex">
          ...
          <div className="max-w-[60%] w-full px-2 flex">
            <p className="font-medium text-lg leading-7 items-center text-justify">
              The Software Industrial Internship is a required component of the
              B.Eng. in Software Engineering program. The objectives are for the
              students to gain work experience in the software industry and to
              understand the role of a software engineer in business and the
              society. Every student is expected to undertake an internship
              position related to software development in a company in Thailand
              or abroad during the summer semester at the end of the second year
              of their study.
            </p>
          </div>
        </div>
        <div className="px-10 my-10 w-full flex">
          ...
          <div className="max-w-[60%] w-full px-2 flex">
            <ul className="font-medium text-lg leading-7 items-center text-justify space-y-1 list-disc list-inside ">
              <li>
                Duration and Timing: The internship takes place in the summer
                semester of Year 2 of the program (late May - late July). The
                internship must consist of at least 7 weeks of full-time work.
                It may be longer if you wish.{" "}
              </li>
              <li>
                Type of Work: An internship provides a excellent opportunity for
                you to apply your software engineering skills in the real world.
                The internship should be practical software engineering work,
                either as an individual project or as part of a larger project.
                You are expected to be involved in the coding of a software
                application or a dynamic website. Work consisting entirely of
                routine testing, internal support, development of a static
                website, or data entry would not be suitable.
              </li>
              <li>
                Supervision: Normally, the host company of your internship will
                assign a member of the company to be your supervisor. The
                supervisor will oversee the progress of your work and give you
                advice. The International College will also nominate one or more
                lecturers to be your internship advisors who will be available
                for consultation to both you and the company.
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="px-10 my-10 w-full flex">
          ...
          <div className="max-w-[60%] w-full px-2">
            <h2 class="mb-2 text-lg font-semibold ">
              The internship is an assessed component of your study. During the
              internship, the company will monitor your performance and then
              submit their assessment to the International College. The
              company's assessment will cover various aspects of your
            ...
            <h2 class="mb-2 text-lg font-semibold ">
              After your internship, you are required to submit an internship
              report and give a presentation of your work and your internship
              experience to the internship assessment committee. The committee
              will then evaluate your internship and give you either grade S
        ...
        <Collaps label="Internship Report">
          <ul className="font-medium text-lg leading-7 items-center text-justify space-y-1 list-disc list-inside ">
            <li>
              a brief outline of the company (its size, its main activities, the
            ...
            <li>
              ...
              environment (for example, tools, techniques, processes, group
              working, deadlines)
            </li>
            <li>
              a reflection on the value of the placement, and how it could have
              been better.
            </li>
            <li>
              The report should not just be a detailed technical description of
              what you did. The assessment committee is looking for a coherent,
              literate report in order to understand how your project fitted
              into the company you were working for, what you achieved, and your
              reflections on how the internship fitted into your educational
              experience.
            </li>
            <li>
              Here are some hints on preparing a good report. Make sure that
              your report has a clear logical structure - it should not be just
              an unstructured flow of words telling a story. Avoid simply
              quoting PR material about the organisation you worked for - think
              about what the reader needs to know about the organisation in
              order to understand the context of your work. Do not focus on
              minute technical detail describing intricate pieces of code that
              you wrote. The biggest problem for most students seems to be
              reflecting on the internship experience. Here are some questions
              you might like to think about in developing this part of the
              report:
            </li>
        ...
        <div className="px-10 my-10 w-full flex">
          ...
          <div className="max-w-[60%] w-full px-2 flex">
            <p className="font-medium text-lg leading-7 items-center text-justify">
              After your internship, you are required to present your work and
              your experience during the internship to the assessment committee
              and your colleagues. You should plan for a 20-minute presentation,
              which will be followed by a 10-minute QA session.
            </p>
          </div>
        </div>
        <div className="px-10 my-10 w-full flex">
          ...
          <div className="max-w-[60%] w-full px-2 flex">
            <p className="font-medium text-lg leading-7 items-center text-justify">
              If, for any reason, you need to take a leave during the
              internship, you must ask for permission from the company. You must
              also submit a document supporting the request for your leave to
              your supervisor in the company (or a person who makes a record of
              your attendance). Absence without notice will result in failing
              the internship.
            </p>
          </div>
        </div>
            ...
            <table class="w-full text-sm text-left text-black-500">
              ...
              <tbody>
                ...
                <tr class="bg-white ">
                  ...
                  <td class="py-4 px-6">
                    {" "}
                    Fri 14 August 2020 16.00-18.30 Room IC06{" "}
                  </td>
                </tr>
              </tbody>
            </table>
