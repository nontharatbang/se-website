    ...
    <div>
      ...
      <div className="my-20 mx-auto px-20 h-full w-full max-w-[1920px]">
        ...
        <p className="font-medium text-lg leading-7 items-center text-justify">
          ...
          courses in the Bachelor Program in Computer Science at FRA-UAS and the
          results and credits of the study be transferred back to their study in
          the SE program.
          <br />
          <br />
          ...
          <br />
          <br />
          Frankfurt University of Applied Sciences (abbreviated as FRA-UAS) is a
          large practice-oriented higher-education institute specializing in
          science and technology. The University is located near the center of
          Frankfurt am Main, a city which is considered a multicultural city and
          the largest financial center in Continental Europe. It has a highly
          international student body, with over 10,000 students from more than
          100 countries. The University has more than 650 academic staff and 220
          administrative staff. There are four faculties:
          <br />
          <br />
          ...
          Each semester is 19-week long, with 15 weeks of teaching. The semester
        ...
        <p className="font-medium text-lg leading-7 items-center text-justify">
          ...
          Semester 2 which have no equivalent counterpart at FRA-UAS. You are to
          take these courses in Year 4 Semester 2 instead:
          <br />
          <br />
          ...
          FRA-UAS does not collect additional tuition fee for your study there.
          You are still required to prepare for other expenses during your
          period of study at Frankfurt. The following table provides a rough
          estimate of the essential expenses (not including leisure activities,
          souvenirs and other unnecessary items):
        </p>
        <div className="text-center">
        ...
        <p className="font-medium text-lg leading-7 items-center text-justify">
          ...
          <b>Application</b>
          <br />
          <br /> The application procedure is as follows: The candidate fills in
          the International College study abroad application form:
          <br />
          ...
          <br />
          FRA-UAS emails each candidate an acceptance letter and an application
          form for accommodations. <br />
